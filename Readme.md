...
git clone https://github.com/ZeinaDweik/book\_shop\_docker

cd book\_shop\_docker/book-shop
...
Database data is stored in a named Docker volume called `postgres\_data`.
...
>>>>>>> c841a49 (Add phase 2 CI/CD pipelines)
